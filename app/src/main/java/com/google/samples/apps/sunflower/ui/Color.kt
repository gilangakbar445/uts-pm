...
val tes = Color(0xFFFBDD9D)
val tes2 = Color(0xFFE8B12D)
val tes3 = Color(0xFF4F4E28)
val tes4 = Color(0xFF925F17)
val tes5 = Color(0xFFE9BF59)
val md_theme_light_primary = Color(0xFFE8B12D)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFDFC995)
val md_theme_light_onPrimaryContainer = Color(0xFF211A00)
val md_theme_light_secondary = Color(0xFFE9BF59)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFDAD2BD)
val md_theme_light_onSecondaryContainer = Color(0xFF272511)
val md_theme_light_tertiary = Color(0xFF4F4E28)
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFC2884A)
val md_theme_light_onTertiaryContainer = Color(0xFF302400)
...
val md_theme_light_background = Color(0xFFFBDD9D)
val md_theme_light_onBackground = Color(0xFF2E2818)

val md_theme_light_surface = Color(0xFFFDFDF6)
val md_theme_light_onSurface = Color(0xFF22221D)
val md_theme_light_surfaceVariant = Color(0xFFDFE4D7)
val md_theme_light_onSurfaceVariant = Color(0xFF43483E)

val md_theme_light_outline = Color(0xFF4F4E28)

val md_theme_light_inverseOnSurface = Color(0xFFF1F1EA)
val md_theme_light_inverseSurface = Color(0xFF363632)
val md_theme_light_inversePrimary = Color(0xFFD6BA66)

val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF6F4200)
val md_theme_light_outlineVariant = Color(0xFFBBB7AB)
